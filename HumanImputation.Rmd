...
normAggLog_test <- readRDS("normAggScale_test.rds")
...
corrClust <- corr_per_clust(x=normAggLog, y=cutClust, clust_total=clust_total)
...
edgelist <- edge_list(corrClust=corrAllClusters, clust_total=clust_total)
