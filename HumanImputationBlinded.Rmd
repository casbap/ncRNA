...
>>>>>>> 1669f51ae3327b34d35b9bf9a43d20f8f7a9d639
...
cl_list <- length(unique(cutClust))
...
sample_kfold <- optimise_impute(cl_list=cl_list, thresh=thresh, cutClustvalues_dynamic=cutClustvalues_dynamic, normAggLog=normAggLog, GO_train=GO_train)
