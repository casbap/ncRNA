...
#The length in cl_list is the minumum cluster size used in the dynamic tree cut. These values are saved in the cutClustvalues_dynamic variable. 
#cluster totals taken from cutClustvalues_dynamic variable and optimised
