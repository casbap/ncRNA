...
# Coarse sweep of the following parameters: cluster total(304,139,93,54,30) and thresholds (0.1 to 0.9). The comments next to the cluster size in cl_list is the minumum cluster size used in the dynamic tree cut. These values are saved in the cutClustvalues_dynamic variable. 
