...
hClust <- as.data.frame(hClust, row.names = "Gene IDs", optional = FALSE,
              cut.names = FALSE, col.names = "Runs (Metadata)", fix.empty.names = TRUE,
              stringsAsFactors = default.stringsAsFactors())
saveRDS(hClust, "hClust")
head(hClust)

# Check the correlation between the distance matrix and the cophenetic distance
...
#ADDITIONAL OPTIMISATION TOOL IF REQUIRED - uncomment
# clusterPass <- cutree(cutClustvalues, h=max(cutClustvalues$height/1.64))
